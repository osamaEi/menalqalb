...
<div class="h-screen flex flex-col">
    <div class="pt-8 px-4">
        <h1 class="text-[24px] text-[#242424] font-[900] z-50 relative text-center">{{__('Join our family')}}</h1>
        ...
        <p class="font-bold mx-auto text-center">{{__('The first step')}}</p>
    </div>
                            ...
                            <form class="space-y-6" method="POST" action="{{ route('app.register') }}">
                                ...
                                <div class="relative !mt-3">
                                    ...
                                    <select id="country_id" name="country_id"
                                        ...
                                        <option value="مصر" {{ old('country_id') == 'مصر' ? 'selected' : '' }}>{{__('Egypt')}}</option>
                                        <option value="المملكة العربية السعودية" {{ old('country_id') == 'المملكة العربية السعودية' ? 'selected' : '' }}>{{__('Saudi Arabia')}}</option>
                                        <option value="الإمارات العربية المتحدة" {{ old('country_id') == 'الإمارات العربية المتحدة' ? 'selected' : '' }}>{{__('United Arab Emirates')}}</option>
                                        <option value="المغرب" {{ old('country_id') == 'المغرب' ? 'selected' : '' }}>{{__('Morocco')}}</option>
                                        <option value="الجزائر" {{ old('country_id') == 'الجزائر' ? 'selected' : '' }}>{{__('Algeria')}}</option>
                                        <option value="لبنان" {{ old('country_id') == 'لبنان' ? 'selected' : '' }}>{{__('Lebanon')}}</option>
                                        <option value="الأردن" {{ old('country_id') == 'الأردن' ? 'selected' : '' }}>{{__('Jordan')}}</option>
                                    </select>
                                ...
                                <div class="relative !mt-3">
                                    <label for="user_type"
                                        class="block text-lg font-medium text-[#4B4B4B] bg-transparent text-center">{{__('Account type')}}</label>
                                ...
                                <div id="companyNameField" class="!mt-1" style="{{ old('user_type') == 'sales_point' ? 'display: block;' : 'display: none;' }}">
                                    <label for="company_name" class="localized" data-content="{{__('Company name')}}"></label>
                                    <div class="bg-[#F9F9F9] max-h-[59px] relative rounded-[35px] mt-0 border !border-black">
                                        <div class="flex items-center">
