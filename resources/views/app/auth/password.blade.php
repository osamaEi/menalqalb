...
@section('content')
<h1 class="text-[24px] text-[#242424] font-[900] z-50 relative">كلمه المرور</h1>
            ...
            <div>
                <div class="rounded-lg px-0 pb-8 w-full">
                    <form class="space-y-6" method="POST" action="{{ route('app.register.password') }}">
                        ...
                        <!-- Password Field -->
                        <div class="!mt-10">
                            <label for="password" class="localized" data-content="كلمه المرور"></label>
                        </div>
                        ...
                        <div class="!mt-10">
                            <label for="password_confirmation" class="localized" data-content="تأكيد كلمه المرور"></label>
                        </div>
                        <div class="bg-[#F9F9F9] max-h-[59px] relative rounded-[35px] mt-0 border !border-black">
                            <div class="flex items-center">
                                <!-- Lock Icon -->
                                <div class="px-4">
                                    <svg id="toggleConfirmPassword" xmlns="http://www.w3.org/2000/svg"
                                        class="cursor-pointer h-6 w-6 text-gray-400" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2"
