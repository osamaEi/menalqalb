...
<div id="rootElement" lang="en">
    ...
    <body class="">
        <div class="app white messagebox">
            <div class="header">
                <a href="index.html"><img src="img/black.png" alt="" class="img-fluid logo"></a>
            </div>
            <h1 class="text-[24px] text-[#242424] font-[900] z-50 relative">نسيت كلمه المرور ؟</h1>
            <p
                class="text-center text-[14px] leading-[29px] max-w-[327px] mx-auto font-[400] text-[#4B4B4B] z-50 mt-4 relative">
                لا تقلق , ادخل رقم هاتفك المسجل لدينا وسنرسل لك رمز
            </p>
            <p class="flex items-center justify-center text-center text-[14px] leading-[29px] 
                ...
                </span> مكون من 4 ارقام عبر تطبيق الواتساب
            </p>
                        ...
                        <div>
                            ...
                            <div class="rounded-lg p-8 w-full">
                                ...
                                <form class="space-y-6">
                                    <!-- Phone Field -->
                                    <label for="txtPhone" class="localized" data-content="رقم الهاتف"></label>
                                    <div
                                        class="bg-[#F9F9F9] h-[55px] relative mt-0 rounded-[39px] border !border-[#000000]">
                                        <div class="flex items-center mt-1">
                                            <!-- Country Flag and Code -->
                                            <div
                                                class="flex items-center p-0 max-w-[126px] max-h-[55px] !border-[#000000]">
                                                <!-- UAE Flag -->
                                                <!-- Flag Selection Component -->
                                                <div class="country-selector relative">
                                                    <!-- Current Selected Country Button -->
                                                    <button type="button" class="!bg-transparent m-0 justify-between flex items-center !border-[#000000] space-x-2 p-2
                                                        rounded-full" id="countryButton">
                                                        <!-- UAE Flag -->
                                                    ...
                                                    <div class="country-dropdown bg-white absolute z-[999999] mt-1 w-64 shadow-lg rounded-[9px] border border-gray-200 hidden"
                                                        ...
                                                        <div class="p-2 border-b border-gray-200">
                                                            <input type="text" placeholder="ابحث عن دولة..."
                                                                class="w-full p-2 border border-gray-300 rounded-[9px] focus:outline-none focus:ring-2 focus:ring-blue-500">
                                                        </div>
                                                        ...
                                                        <div class="max-h-60 overflow-y-auto py-1">
                                                            <!-- UAE -->
                                                            <div
                                                                class="country-item flex items-center p-2 hover:bg-gray-100 cursor-pointer">
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        <rect width="40" height="8" fill="#00732f" />
                                                                        <rect y="8" width="40" height="8"
                                                                            fill="#ffffff" />
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        ...
                                                                        <g transform="translate(13, 8)">
                                                                            <path d="M0,0 H18 M0,4 H18 M9,0 V8"
                                                                                stroke="#fff" stroke-width="1" />
                                                                            <text x="9" y="6" font-size="4"
                                                                                text-anchor="middle" fill="#fff">لا إله
                                                                                إلا الله</text>
                                                                        </g>
                                                                    </svg>
                                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        <rect width="40" height="24" fill="#8d1b3d" />
                                                                        <path d="M 0,0 L 11,0 L 11,24 L 0,24 Z"
                                                                            fill="#ffffff" />
                                                                        <path d="M 0,0 L 11,0 L 11,24 L 0,24 L 9,12 Z"
                                                                            fill="#8d1b3d" />
                                                                    </svg>
                                                                </div>
                                                                <span class="text-sm">قطر</span>
                                                                <span class="text-sm text-gray-500 mr-auto">+974</span>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        <rect width="40" height="8" fill="#007a3d" />
                                                                        <rect y="8" width="40" height="8"
                                                                            fill="#ffffff" />
                                                                        <rect y="16" width="40" height="8"
                                                                            fill="#ce1126" />
                                                                        <polygon points="0,0 0,24 13,16 13,8"
                                                                            fill="#000000" />
                                                                    </svg>
                                                                </div>
                                                                <span class="text-sm">الكويت</span>
                                                                <span class="text-sm text-gray-500 mr-auto">+965</span>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        <rect width="40" height="24" fill="#ce1126" />
                                                                        <path
                                                                            d="M 0,0 L 13,0 L 8,4 L 13,8 L 8,12 L 13,16 L 8,20 L 13,24 L 0,24 Z"
                                                                            fill="#ffffff" />
                                                                    </svg>
                                                                </div>
                                                                <span class="text-sm">البحرين</span>
                                                                <span class="text-sm text-gray-500 mr-auto">+973</span>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        ...
                                                                        <rect y="16" width="40" height="8"
                                                                            fill="#008000" />
                                                                        <rect width="12" height="24" fill="#db161b" />
                                                                    </svg>
                                                                </div>
                                                                <span class="text-sm">عمان</span>
                                                                <span class="text-sm text-gray-500 mr-auto">+968</span>
                                                            </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="flag-icon w-8 h-5 mr-3">
                                                                    <svg viewBox="0 0 40 24" class="w-full h-full">
                                                                        <rect width="40" height="8" fill="#000000" />
                                                                        <rect y="8" width="40" height="8"
                                                                            fill="#ffffff" />
                                                                        <rect y="16" width="40" height="8"
                                                                            fill="#007a3d" />
                                                                        <polygon points="0,0 0,24 20,12"
                                                                            fill="#ce1126" />
                                                                        <circle cx="7" cy="12" r="2" fill="#ffffff" />
                                                                    </svg>
                                                                </div>
                                                                <span class="text-sm">الأردن</span>
                                                                <span class="text-sm text-gray-500 mr-auto">+962</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="flex justify-center">
                                        ...
                                        <a href="otp_code.html" class="!m-0 !h-[55px] !w-[100%] mt-0 !font-[400] flex items-center justify-center 
                                ...
                                <div class="!mt-5 ">
                                    <a href="index.html" class="!text-[#B62326] !border-0 text-[16px] !font-[400]">لدي
                                        حساب</a>
                                </div>
                            </div>

                            <!-- Country Flags Preview Collection -->
                            <div class="fixed bottom-4 left-4 p-4 rounded-lg shadow-lg" style="display: none;">
                                <h3 class="text-center font-bold mb-2">أعلام الدول</h3>
                                <div class="grid grid-cols-5 gap-2">
                                    ...
                                    <div class="flag-icon">
                                        <svg viewBox="0 0 40 24">
                                            ...
                                            <g transform="translate(14, 8)">
                                                <path d="M 0,0 H 18 V 8 H 0 Z" fill="none" stroke="#fff"
                                                    stroke-width="1" />
                                                <text x="9" y="6" font-size="6" text-anchor="middle"
                                                    fill="#fff">شهادة</text>
                                            </g>
                                        </svg>
                                    </div>
                                    ...
                                    <div class="flag-icon">
                                        <svg viewBox="0 0 40 24">
                                            <rect width="40" height="24" fill="#8d1b3d" />
                                            <path d="M 0,0 L 11,0 L 11,24 L 0,24 Z" fill="#ffffff" />
                                            <path d="M 0,0 L 11,0 L 11,24 L 0,24 L 9,12 Z" fill="#8d1b3d" />
                                        </svg>
                                    </div>
                                    ...
                                    <div class="flag-icon">
                                        <svg viewBox="0 0 40 24">
                                            <rect width="40" height="8" fill="#007a3d" />
                                            <rect y="8" width="40" height="8" fill="#ffffff" />
                                            <rect y="16" width="40" height="8" fill="#ce1126" />
                                            <polygon points="0,0 0,24 13,16 13,8" fill="#000000" />
                                        </svg>
                                    </div>
                                </div>
                            </div>
