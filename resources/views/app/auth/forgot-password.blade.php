...
@section('content')
    <div class="app messagebox">
        ...
        <h1 class="text-[24px] text-[#242424] font-[900] z-50 relative">{{__('Forgot your password?')}}</h1>
        <p class="text-center text-[14px] leading-[29px] max-w-[327px] mx-auto font-[400] text-[#4B4B4B] z-50 mt-4 relative">
            {{__('Don\'t worry, enter your registered phone number, and we will send you a 4-digit code via WhatsApp')}}
        </p>
                ...
                <div class="All_Button lang Devices">
                    <div class="rounded-lg p-8 w-full">
                        ...
                        <div class="!mt-5 text-center">
                            <a href="{{ route('app.login') }}" class="!text-[#B62326] !border-0 text-[16px] !font-[400]">{{__('I have an account')}}</a>
                        </div>
                    </div>
                </div>
            </div>
