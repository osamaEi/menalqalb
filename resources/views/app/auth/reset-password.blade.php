@extends('app.index')
@section('content')
        <h1 class="text-[24px] text-[#242424] font-[900] z-50 relative">{{__('Reset password')}}</h1>
                    ...
                    <div class="rounded-lg p-8 w-full">
                        ...
                        <form class="space-y-6" method="POST" action="{{ route('app.forgot-password.reset.store') }}">
                            ...
                            <div class="bg-[#F9F9F9] h-[55px] relative mt-0 rounded-[39px] border !border-[#000000]">
                                <input type="password" name="password" id="passwordInput" class="w-full h-full text-center bg-transparent px-4 text-lg focus:outline-none" placeholder="{{__('Password')}}" required>
                            ...
                            @enderror
                            <div class="bg-[#F9F9F9] h-[55px] relative mt-0 rounded-[39px] border !border-[#000000]">
                                <input type="password" name="password_confirmation" class="w-full h-full text-center bg-transparent px-4 text-lg focus:outline-none" placeholder="{{__('Confirm password')}}" required>
                            </div>
