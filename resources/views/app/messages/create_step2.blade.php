...
<div id="rootElement" lang="en_US">
    ...
    <body class>
        ...
        <div class="app white messagebox">
            <div class="header">
                <a href="{{ route('app.messages.create.step1') }}" class="icondoor"><i class="fas fa-arrow-alt-circle-left"></i>
                </a>
            ...
            <div class="row justify-content-center">
                <div>
                    ...
                    <div class="gap-2 text-center justify-center items-center px-3 flex flex-column">
                        <div>
                            <h3 for="txtMessage Box" class="font-bold block text-[#B62326] text-[17px] 
                                localized" data-content="إختر بطاقة التهنئة">
                                إختر بطاقة التهنئة
                            </h3>
                        </div>
                        ...
                        <div class="flex justify-between items-center gap-3 px-2">
                            <p class="name flex items-center justify-center gap-2">
                                {{ $step1Data ? App\Models\Category::find($step1Data['main_category_id'])->name ?? 'التصنيف الرئيسي' : 'التصنيف الرئيسي' }}

                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M12.3701 8.87988H17.6201" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.37988 8.87988L7.12988 9.62988L9.37988 7.37988" stroke="#292D32"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12.3701 15.8799H17.6201" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M6.37988 15.8799L7.12988 16.6299L9.37988 14.3799" stroke="#292D32"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                            ...
                            <p class="name flex items-center justify-center gap-2">
                                {{ $step1Data ? App\Models\Category::find($step1Data['sub_category_id'])->name_ar ?? 'التصنيف الفرعي' : 'التصنيف الفرعي' }}
                        ...
                        <div class="flex justify-between items-center gap-3 px-2">
                            <p class="text-black name flex items-center justify-center gap-2 w-[149px]">
                                {{ $step1Data && $step1Data['recipient_language'] == 'ar' ? 'العربية' : 'English' }}
                            ...
                            <p class="text-black name flex items-center justify-center gap-2 w-[149px]">
                                {{ $step1Data ? App\Models\CardType::find($step1Data['dedication_type_id'])->type ?? 'نوع الإهداء' : 'نوع الإهداء' }}
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="white">
                                    <path
                                        ...
                                        stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M2.51953 7.11035H21.4795" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8.51953 2.11035V6.97034" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.4795 2.11035V6.52039" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M16.75 18.4996L17.86 19.6096L20.26 17.3896" stroke="#292D32"
                                        stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </p>
                        </div>
                                        ...
                                        <ul class="allDevice">
                                                    ...
                                                    <li class="relative card-item" data-id="{{ $card->id }}">
                                                        ...
                                                        <div class="flex flex-row-reverse w-[100%]">
                                                            ...
                                                            <div class="items-center justify-center flex flex-col"
                                                                ...
                                                                class="flex justify-between items-center !gap-0 mb-[7px] h-[48px] rounded-[15px] relative bottom-[-17px]">
                                                                <!-- View Button -->
                                            ...
                                            @else
                                                <li class="text-center py-5">
                                                    <p>لم يتم العثور على بطاقات في هذا التصنيف</p>
                                                </li>
                                            @endif
                                        </ul>
